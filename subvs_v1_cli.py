...
class subvs_cli_:
    ...
    def __init__(self) :
       ...
       self.parameters={'vis':None, 'outputvis':None, 'timerange':None, 'spw':None, 'subtime1':None, 'subtime2':None, 'splitsel':None, 'reverse':None, 'overwrite':None, }
    ...
    def __call__(self, vis=None, outputvis=None, timerange=None, spw=None, subtime1=None, subtime2=None, splitsel=None, reverse=None, overwrite=None, ):
...
#
	...
	try :
	    ...
	    #return False
          ...
          result = subvs(vis, outputvis, timerange, spw, subtime1, subtime2, splitsel, reverse, overwrite)
