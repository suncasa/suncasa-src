...
if os.path.exists(FS_dspecDF):
    ...
    tab3_r_aia_submap_cross = tab3_p_aia_submap.cross(x='x_pos', y='y_pos', size=15,
                                                      color={'field': 'freq', 'transform': color_mapper}, line_width=2,
    ...
    def tab3_BUT_plot_xargs_default():
        ...
        tab3_plot_xargs_dict['linestyle'] = "False"
    ...
    #     global tab3_plot_xargs_dict, timebin, linestyle
    #     txts = tab3_input_timebin.value.strip()
    #     txts = txts.split(';')
    #     for txt in txts:
    #         txt = txt.split('=')
    #         if len(txt) == 2:
    ...
    #         tab3_plot_xargs_dict['timebin'] = 1
    #     if not 'linestyle' in tab3_plot_xargs_dict.keys():
    #         tab3_plot_xargs_dict['linestyle'] = False
                ...
                if len(txt) == 2:
                    ...
                    if key == 'linestyle':
                        if val not in ['True', 'False']:
                            val = "False"
                    tab3_plot_xargs_dict[key] = val
                    if key not in ['timebin', 'linestyle']:
    ...
    tab3_input_timebin = TextInput(value='Input the param here', title="Plot parameters:", width=300)
    ...
    panel3 = row(column(tab3_p_aia_submap, tab3_Div_Tb), column(
        row(gridplot([tab3_p_dspec_small], [tab3_p_dspecvx_small], [tab3_p_dspecvy_small],
            ...
            column(tab3_Slider_ANLYS_idx,
                   ...
                   tab3_input_timebin, tab3_Div_plot_xargs))))
